...
public class MusicPlayerTileEntityRenderer extends TileEntitySpecialRenderer {
    ...
    private static final net.minecraft.src.ResourceLocation TEXTURE = new net.minecraft.src.ResourceLocation("netmusic:textures/blocks/music_player.png");
    ...
    private void renderLyric(TileEntityMusicPlayer te, double x, double y, double z) {
        ...
        net.minecraft.src.FontRenderer font = this.getFontRenderer();
