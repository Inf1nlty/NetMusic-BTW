...
public class BlockCDBurner extends BlockContainer {
    ...
    public BlockCDBurner(int id) {
        ...
        this.setUnlocalizedName("cd_burner");
        this.setTextureName("netmusic:cd_burner");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float offsetX, float offsetY, float offsetZ) {
        ...
        if (player instanceof EntityPlayerMP mp) {
            openMenu(world, x, y, z, mp);
        }
        return true;
    }

    private static void openMenu(World world, int x, int y, int z, EntityPlayerMP player) {
        TileEntity tileEntity = world.getBlockTileEntity(x, y, z);
        TileEntityCDBurner burner = tileEntity instanceof TileEntityCDBurner ? (TileEntityCDBurner) tileEntity : new TileEntityCDBurner();
        ...
        NetworkHandler.sendToClientPlayer(new OpenMenuMessage(OpenMenuMessage.Type.CD_BURNER, windowId, x, y, z), player);
