...
public class NetMusicCommand extends CommandBase {
    ...
    private static void giveSongCdDirect(EntityPlayerMP player, ICommandSender sender, ItemMusicCD.SongInfo songInfo, String successKey) {
    ...
    private static void applySongForSource(EntityPlayerMP player, ICommandSender sender, ItemMusicCD.SongInfo songInfo,
    ...
    private static int setSongToOpenMenu(EntityPlayerMP player, ICommandSender sender, ItemMusicCD.SongInfo songInfo) {
    ...
    private static boolean writeSongToInventoryCd(EntityPlayerMP player, ItemMusicCD.SongInfo songInfo) {
    ...
    private static boolean writeSongWithSourceInteractionCheck(EntityPlayerMP player, ICommandSender sender, ItemMusicCD.SongInfo songInfo,
