...
public class ItemMusicCD extends Item {
    ...
    public ItemMusicCD(int id) {
        super(id);
        this.setUnlocalizedName("music_cd");
        this.setTextureName("netmusic:music_cd");
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean extendedInfo) {
        super.addInformation(stack, player, tooltip, extendedInfo);
